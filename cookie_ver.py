...
def initDriver():
    CHROMEDRIVER_PATH = '/home/beter/Selenium_Java/Documents/chromedriver_linux64/chromedriver'
...
cookie = 'fr=03OLqt78wgePRXpbZ.AWW4QJ5b0w05plhDzQEduRpez4w.Bhc6gD.Re.AAA.0.0.Bhc_B6.AWU6Xek_Obw; sb=EEIRYT_X_31wB0CW9gKfVILK; datr=EEIRYcxl2dCv_RLnLzxt7mz3; _fbp=fb.1.1628523490235.1358472938; wd=1354x327; locale=vi_VN; m_pixel_ratio=1; x-referer=eyJyIjoiL0N1YWhhbmcudGllbi5pY2guTGluaER1b25nLyIsImgiOiIvQ3VhaGFuZy50aWVuLmljaC5MaW5oRHVvbmcvIiwicyI6InRvdWNoIn0%3D; c_user=100007773318062; xs=4%3ALRZY9G9JCcz7vQ%3A2%3A1634988152%3A-1%3A15761; spin=r.1004607820_b.trunk_t.1635064293_s.1_v.2_'
driver = initDriver()
isLive = checkLiveCookie(driver, cookie)
if (isLive):
    getnumOfPostFanpage(driver, 'Tới-Trần-108295773927904', 20, 'posts.csv')
    for postId in readData('posts.csv'):
        getAmountOfComments(driver, postId, 50000)
